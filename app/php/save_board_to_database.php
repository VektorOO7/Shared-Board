<?php
    ...
    if (!isset($boardData['board_id']) || !isset($boardData['user_id']) || !isset($boardData['board_title'] || !isset($boardData['board_share_password'])) {
    ...
    try {
        ...
        $sql = "INSERT INTO boards (board_id, user_id, board_title, board_share_password) VALUES (?,?,?, ?)";
        $stmnt = $conn->prepare($sql);
        $stmnt->execute([$boardData["board_id"], $boardData["user_id"], $boardData["board_title"], $boardData["board_share_password"]]);
